...
class Core_Tests extends Base\TestCase {
	...
	public function test_i18n() {
		...
		\WP_Mock::onFilter( 'plugin_locale' )->with( 'en_US', 'muui-components' )->reply( 'en_US' );
		\WP_Mock::userFunction( 'load_textdomain', array(
			'times' => 1,
			'args' => array( 'muui-components', 'lang_dir/muui-components/muui-components-en_US.mo' ),
		) );
		...
		\WP_Mock::userFunction( 'load_plugin_textdomain', array(
			'times' => 1,
			'args' => array( 'muui-components', false, 'path/languages/' ),
		) );
	...
	public function test_init() {
		// Setup
		\WP_Mock::expectAction( 'muui_components_init' );
